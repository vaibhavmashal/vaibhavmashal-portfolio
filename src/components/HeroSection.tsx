...
export default function HeroSection() {
  return (
    <section className="text-center">
      ...
      <h2 className="text-xl text-gray-600 dark:text-gray-400 mb-4 transform transition duration-500 ease-in-out hover:translate-y-1">
        Full Stack Developer Intern at  
        <span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">
           {' '}Webtech Developers
        </span>
      </h2>
      <p className="max-w-2xl mx-auto mb-8 font-semibold text-gray-600 dark:text-gray-400 transform transition duration-500 ease-in-out hover:translate-y-1">
        Passionate about creating elegant solutions to complex problems. With expertise in
        Full Stack Development and cloud technologies, I build scalable and efficient web applications
      ...
      <div className="flex flex-col items-center space-y-4 sm:flex-row sm:justify-center sm:space-x-4 sm:space-y-0 border border-gray-500 rounded-lg sm:border-0 p-4">
        <div className="grid grid-cols-2 gap-4 sm:flex sm:space-x-4">
          ...
          <Link className="btn btn-icon w-full sm:w-auto group hover:bg-primary hover:text-primary-foreground transition-colors duration-300 flex items-center justify-center" href="/Vaibhav_Mashal_Resume.pdf" target="_blank" rel="noopener noreferrer">
            <FaFilePdf className="mr-2 h-5 w-5 group-hover:scale-110 transition-transform duration-300" />
            Resume
          </Link>
