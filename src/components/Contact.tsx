...
export default function Contact() {
  return (
    <section id='contact' className="text-center py-20">
      ...
      <form className="max-w-xl border border-gray-600 rounded-md py-5 px-6 mx-auto space-y-4 mt-10 transform transition duration-500 ease-in-out hover:scale-105">
        <div>
          <input
            type="text"
            name="name"
